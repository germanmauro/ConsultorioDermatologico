                               ...
                               <ul class="hs">
                                   <?php
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        echo "<li onclick=paginaPrincipal('pedidomodificar.php?categoria=" . $row["Id"] . "') class='item" . ($row["Prioridad"] == 0 ? ' oferta' : '') . "'>" . $row["Nombre"] . "</li>";
                                    }
                                    ?>
                                   <li onclick=paginaPrincipal('pedidomodificar.php?categoria=0') class='item'>Todas</li>
                               </ul>
                           </div>
                       </div>
                   </div>
