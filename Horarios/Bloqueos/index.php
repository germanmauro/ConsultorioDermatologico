            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Días bloqueados para <?= $medico->nombre . " " . $medico->apellido ?></h2>
                    ...
                    $sql = "SELECT DATE_FORMAT(dia,'%d/%m/%Y') as dia, id
                     FROM bloqueos
