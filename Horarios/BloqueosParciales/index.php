...
<head>
    <meta charset="UTF-8">
    <title>Gestión de Días bloqueados pacialmente</title>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Días bloqueados parcialmente para <?= $medico->nombre . " " . $medico->apellido ?></h2>
                    ...
                    $sql = "SELECT motivo,DATE_FORMAT(dia,'%d/%m/%Y') as dia,horadesde,horahasta, id
